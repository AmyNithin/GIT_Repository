...
public class test {
	...
	public static void main(String[] args) throws Exception {
		...
		wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//a[@class='btn btn-tertiary-alt global-ceiling-bar-btn']")));
		...
		// wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//li[@class='ba-banklist--item
		// xui-contentblock--item']")));
